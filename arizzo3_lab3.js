//Alec Rizzo - arizzo3
//Lab 3 - used cubeindexed.js as the base for this lab
...
function colorCube()
{
    //commented out this quad call so that the inside of
    // the pyramid wouldn't have its face drawn
    //quad( 1, 0, 3, 2, 0 );

    //only using colors 0,1,2,3,4
